<template>
    ...
    <div v-else class="flex flex-col gap-8 fade-in py-4 w-full">

        <!-- Header -->
        <div class="flex flex-col lg:items-start items-center gap-1">
            <h1 class="text-2xl sm:text-3xl font-bold text-center lg:text-left">Mon compte</h1>
        ...
        <div class="flex items-center gap-3 p-4 rounded-xl border border-zinc-700 bg-zinc-800/30 w-fit">
            ...
            <span class="text-sm text-gray-400">Solde actuel</span>
            ...
            <NuxtLink to="/shop">
                <Button severity="secondary" size="small" outlined>
                    ...
                    <span class="text-xs">Acheter</span>
                </Button>
            </NuxtLink>
        </div>
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="p-5 rounded-xl border-2 transition-all"
                ...
                <div class="flex items-center justify-between gap-4 flex-wrap">
                    ...
                    <Button v-if="isSub" severity="secondary" outlined @click="openPortal">
        ...
        <div class="flex flex-col gap-3">
            ...
            <div v-else class="flex flex-col gap-2">
                <div v-for="tx in history" :key="tx.id"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col">
                            <span class="text-sm font-medium">{{ txLabel(tx.type) }}</span>
            ...
            <Button v-if="historyHasMore" severity="secondary" outlined class="w-full mt-2" :loading="historyLoading"
