...
useSeoMeta({
    ...
    ogTitle: 'Boutique Charmi',
    ogDescription: 'Charm, fonctionnalités exclusives, Charmi+… Tout pour booster ton stream.',
    ogImage: 'https://charmi.gg/images/og/og-shop.png',
