<template>
    ...
    <button @click="openModal"
        class="flex items-center gap-2 px-3 py-2 rounded-md border border-white/8 hover:border-white/20 hover:bg-white/5 text-sm font-semibold text-muted hover:text-white transition-colors">
        <Icon name="lucide:pencil" size="16" />
        <span class="text-xs sm:text-sm">Modifier l'avatar</span>
    </button>
    <!-- Modal -->
