                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <template v-if="!hasFeature('no_branding') && !isSub">
                                <button @click="brandingModal = true"
                                    class="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-surface-darker border border-white/8 hover:border-white/20 font-semibold text-white transition-colors shrink-0">
